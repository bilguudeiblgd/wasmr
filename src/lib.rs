...
/// Compile R source code to WAT (WebAssembly Text format)
///
/// This function provides a browser-compatible API for the compiler.
/// It takes R source code as a string and returns the compiled WAT output.
///
/// # Arguments
/// * `source` - R source code as a string
///
/// # Returns
/// * `Result<String, String>` - WAT text format on success, error message on failure
///
/// # Example (in JavaScript)
/// ```javascript
/// const wat = compile_to_wat("x <- 42\nprint(x)");
/// console.log(wat);
/// ```
