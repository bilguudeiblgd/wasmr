(module
  ...
  (type (;5;) (func))
  (type (;6;) (func))
  (type (;7;) (struct (field (mut i32))))
  (type (;8;) (struct (field i32) (field (ref 7))))
  (type (;9;) (func (param (ref 8))))
  (type (;10;) (func (param (ref 8))))
  (type (;11;) (func (param (ref 8))))
  (type (;12;) (func))
  ...
  (func (;5;) (type 9) (param (ref 8))
    local.get 0
    struct.get 8 1
    i32.const 10
    struct.set 7 0
  )
  (func (;6;) (type 10) (param (ref 8))
    i32.const 0
    local.get 0
    struct.get 8 1
    struct.new 8
